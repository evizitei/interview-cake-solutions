require_relative "../lib/pointers_graph"

describe "PointersGraph" do
  let(:graph){ PointersGraph.new }
  ...
  describe "insert_edge" do
    it "can create an edge between existing nodes" do
      ...
      expect(edge.node_one.value).to eq(7)
      expect(edge.node_two.value).to eq(12)
    end
